...
PATH="$TOP/prebuilts/clang/host/linux-x86/clang-4053586/bin:$PATH"
...
export LD_LIBRARY_PATH="$TOP/prebuilts/clang/host/linux-x86/clang-4053586/lib64:$LD_LIBRARY_PATH"
